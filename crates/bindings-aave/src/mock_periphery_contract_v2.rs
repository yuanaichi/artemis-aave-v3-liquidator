...
pub mod mock_periphery_contract_v2 {
    ...
    impl ::ethers::core::abi::AbiDecode for MockPeripheryContractV2Calls {
        fn decode(
            ...
            if let Ok(decoded) = <GetAddressesProviderCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::GetAddressesProvider(decoded));
            }
            if let Ok(decoded) = <GetManagerCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
            ...
            if let Ok(decoded) = <SetManagerCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
