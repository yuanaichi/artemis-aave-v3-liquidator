...
pub mod l2_pool {
    ...
    impl ::ethers::core::abi::AbiDecode for L2PoolCalls {
        fn decode(
            ...
            if let Ok(decoded) = <BorrowWithAssetCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
            ...
            if let Ok(decoded) = <LiquidationCallWithCollateralAssetAndDebtAssetCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
            ...
            if let Ok(decoded) = <RebalanceStableBorrowRateWithAssetCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
            ...
            if let Ok(decoded) = <RepayWithAssetCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::RepayWithAsset(decoded));
            }
            if let Ok(decoded) = <RepayWithATokensWithAssetCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
            ...
            if let Ok(decoded) = <RepayWithPermitWithAssetAndAmountAndInterestRateModeCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(
            ...
            if let Ok(decoded) = <SetUserUseReserveAsCollateralWithAssetCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::SetUserUseReserveAsCollateralWithAsset(decoded));
            }
            if let Ok(decoded) = <SupplyWithAssetCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
            ...
            if let Ok(decoded) = <SupplyWithPermitWithAssetAndAmountAndOnBehalfOfCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(
            ...
            if let Ok(decoded) = <SwapBorrowRateModeWithAssetCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
            ...
            if let Ok(decoded) = <WithdrawWithAssetCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
